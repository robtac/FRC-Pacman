...
# Modified by Robbie Tacescu, May 2018
# Changed the icons to fit the theme of FRC Robotics Team 6305
...
ghostcolor[0] = (255, 0, 0, 255)
ghostcolor[1] = (255, 0, 0, 255)
ghostcolor[2] = (255, 0, 0, 255)
ghostcolor[3] = (255, 0, 0, 255)
...
class ghost ():
    ...
    def __init__ (self, ghostID):
        ...
        self.anim[0] = pygame.image.load(os.path.join(SCRIPT_PATH, "res", "sprite", "ghost " + str(self.id + 1) + ".gif")).convert()
        self.anim[1] = pygame.image.load(os.path.join(SCRIPT_PATH, "res", "sprite", "ghost " + str(self.id + 4) + ".gif")).convert()
    ...
    def Draw (self):
        ...
        if self.state == 1:
            ...
            screen.blit (self.anim[0], (self.x - thisGame.screenPixelPos[0], self.y - thisGame.screenPixelPos[1]))
        elif self.state == 2:
            # draw vulnerable ghost
            screen.blit(self.anim[1],
...
class pacman ():
    ...
    def __init__ (self):
        ...
        for i in range(1, 9, 1):
            ...
            self.anim_pacmanL[i] = pygame.image.load(os.path.join(SCRIPT_PATH,"res","sprite","pacman.gif")).convert()
            self.anim_pacmanR[i] = pygame.image.load(os.path.join(SCRIPT_PATH,"res","sprite","pacman.gif")).convert()
            self.anim_pacmanU[i] = pygame.image.load(os.path.join(SCRIPT_PATH,"res","sprite","pacman.gif")).convert()
            self.anim_pacmanD[i] = pygame.image.load(os.path.join(SCRIPT_PATH,"res","sprite","pacman.gif")).convert()
            self.anim_pacmanS[i] = pygame.image.load(os.path.join(SCRIPT_PATH,"res","sprite","pacman.gif")).convert()
